"""
Main script for the Mini LLM project with enhanced data loading capabilities.
This version adds support for loading different file types and flexible text splitting.
"""
import argparse
import logging
import os
...
def main():
    ...
    parser.add_argument("--mode", type=str, required=True, choices=["train", "test", "generate", "ui"],
                        help="Mode to run: train, test, generate, or ui")
